  ...
  return (
    <section className="w-full max-w-4xl mx-auto py-4">
      <div ref={heroRef} className="flex flex-col gap-6">
        ...
        >
          I’m Arham Jain, a{" "}
          <span className="text-[#1D56CF] border-b-4 border-[#1D56CF]/20 inline-block px-1">
        ...
        <div className="space-y-5 text-base md:text-lg text-slate-600 leading-relaxed">
          ...
          <TimelineContent as="p" animationNum={1} timelineRef={heroRef}>
            ...
            <span className="text-orange-600 font-semibold bg-orange-50 px-2 py-0.5 rounded-md border border-orange-100">
              Artificial Intelligence
            </span>
            , I explore how logic and data create smarter products. My journey started in{" "}
            <span className="text-green-600 font-semibold bg-green-50 px-2 py-0.5 rounded-md border border-green-100">
              7th grade
            </span>
          ...
          <TimelineContent as="p" animationNum={2} timelineRef={heroRef}>
            ...
            <span className="text-amber-600 font-semibold bg-amber-50 px-2 py-0.5 rounded-md border border-amber-100">
              solving practical problems
            </span>
             debugging broken flows and making products feel{" "}
            <span className="text-teal-600 font-semibold bg-teal-50 px-2 py-0.5 rounded-md border border-teal-100">
          ...
          <TimelineContent as="p" animationNum={4} timelineRef={heroRef} className="italic font-medium text-slate-800 border-l-4 border-[#1D56CF] pl-4 py-1 bg-gray-50/50 rounded-r-lg">
            I don’t just build websites. I build things that are meant to work in the real world.
          </TimelineContent>
        </div>

        {/* Bottom CTA Area */}
        <div className="flex flex-wrap items-center gap-4 mt-2 pt-6 border-t border-slate-100">
          <TimelineContent
            as="div"
            animationNum={5}
            timelineRef={heroRef}
          ...
          >
            <div className="font-semibold text-slate-900">Arham Jain</div>
